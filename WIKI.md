...
1. **Open the [FilamentManager Web Installer](https://olyforge3d.github.io/FilamentManager/installer/)**
...
Default PN532 wiring is software SPI and varies by firmware target:
...
| Component | Default GPIO | Function |
|---|---:|---|
...
- **PN532 DIP switches** must be set to SPI mode
...
For full schema details and examples, see [manufacturer_tags.md](manufacturer_tags.md).
...
- Solution: Check PN532 DIP switches (SPI mode)
...
- **Interface**: Software SPI (board defaults can be changed in Hardware settings)
- **IRQ Pin**: Interrupt-based tag detection
- **Reset Handling**: Automatic recovery from communication errors
- **DIP Switches**: Must be set to SPI mode
